...
const FEATURES: any = [
  {position: 1, siteFacility: '5 Hardstanding pitches', feature: 'With electric hookup'},
  {position: 2, siteFacility: '10 grass pitches', feature: '	Optional electric hookup for tents'},
